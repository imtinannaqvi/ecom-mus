...
import useProduct from "../hooks/productService"; // Aapka custom hook
...
const MegaMenu = ({ mainCat, closeMenu }) => {
  ...
  return (
    <>
      ...
      {/* Menu Content */}
      <div
        className="absolute left-0 top-full w-full bg-black text-white text-gray-800 py-12 px-8 shadow-2xl z-50 border-t border-gray-100 animate-in fade-in slide-in-from-top-2 duration-300"
        onMouseLeave={closeMenu}
      >
        <div className="max-w-7xl mx-auto">
  {/* 
      1. h-[250px] -> Ye define karta hai ki ek column kitna lamba hoga. 
      2. flex-wrap -> Jab height khatam hogi toh ye next column banayega.
      3. content-start -> Taake columns ke beech mein faltu space na aaye.
  */}
          ...
          {allCategories.map((cat) => (
            ...
            >
              <Link
                ...
                className={`text-[12px] font-black uppercase tracking-[0.2em] transition-all pb-1 border-b-2 ${
                  activeMenu?._id === cat._id
